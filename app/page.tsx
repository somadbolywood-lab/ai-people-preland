    ...
    <div className="container home-page">
      ...
      <main>
        ...
        <section className="hero">
          <h1 className="title"><span className="gradient-text" data-lang-en="Marketplace" data-lang-ru="Маркетплейс">Marketplace</span></h1>
          <h2 className="hero-subtitle" data-lang-en="Buy and sell hyperrealistic virtual influencers or employees" data-lang-ru="Покупайте и продавайте гиперреалистичных виртуальных инфлюэнсеров или сотрудников">Buy and sell hyperrealistic virtual influencers or employees</h2>
          <h3 className="hero-description" data-lang-en="The world's first curated platform for premium AI content. Join today the community of creators revolutionizing digital marketing." data-lang-ru="Первая в мире курируемая платформа для премиального AI-контента. Присоединяйтесь уже сегодня к сообществу креаторов революционизирующих цифровой маркетинг.">The world's first curated platform for premium AI content. Join today the community of creators revolutionizing digital marketing.</h3>
        </section>
