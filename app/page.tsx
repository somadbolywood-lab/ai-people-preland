    ...
    <div className="container">
      <header className="topbar">
        <div className="brand">
          ...
          <a href="mailto:feedback@ai-people.com" className="btn outline feedback-btn">
            ...
            <span data-lang-en="Feedback" data-lang-ru="Обратная связь">Feedback</span>
          </a>
      ...
      <main>
        ...
        <section className="hero">
          <h1 className="title">
            <span className="gradient-text" data-lang-en="AI Models Marketplace:" data-lang-ru="Маркетплейс AI-моделей:">AI Models Marketplace:</span>
            <br />
            <span data-lang-en="Buy & Sell Hyperrealistic Virtual Influencers" data-lang-ru="Покупайте и продавайте гиперреалистичных виртуальных инфлюенсеров">Buy & Sell Hyperrealistic Virtual Influencers</span>
          </h1>
          <p className="subtitle" data-lang-en="The world's first curated platform for premium AI-generated content. Join the community of creators and brands revolutionizing digital marketing." data-lang-ru="Первая в мире курируемая платформа для премиум AI-контента. Присоединяйтесь к сообществу креаторов и брендов, революционизирующих цифровой маркетинг.">The world's first curated platform for premium AI-generated content. Join the community of creators and brands revolutionizing digital marketing.</p>
        </section>
        ...
        <section className="content-section">
          ...
          <div className="call-to-action" style={{marginTop: '3rem', marginBottom: '4rem', textAlign: 'center'}}>
            ...
            <a href="/auth/role" className="btn primary" style={{marginTop: '1.5rem', display: 'inline-block'}}><span data-lang-en="Join the Waiting List — Launching Nov 1, 2025" data-lang-ru="Присоединиться к списку ожидания — Запуск 01.11.2025">Join the Waiting List — Launching Nov 1, 2025</span></a>
          </div>
        </section>
      </main>
