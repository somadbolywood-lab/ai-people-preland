    ...
    <>
      ...
      <main>
        <section className="hero">
          ...
          <h2 className="hero-subtitle" data-lang-en="Everything you need to know about the marketplace of ready-made virtual AI models and earning opportunities" data-lang-ru="Всё, что нужно знать о маркетплейсе готовых виртуальных AI-моделей и возможностях заработка">Everything you need to know about the marketplace of ready-made virtual AI models and earning opportunities</h2>
          <h3 className="hero-description" data-lang-en="How technology, creativity and monetization come together in one AI space. Create, own and earn on digital images of the future using the power of AI." data-lang-ru="Как технологии, креатив и монетизация объединяются в одном AI-пространстве. Создавай, владей и зарабатывай на цифровых образах будущего, используя потенциал AI.">How technology, creativity and monetization come together in one AI space. Create, own and earn on digital images of the future using the power of AI.</h3>
        </section>
