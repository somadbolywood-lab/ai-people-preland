  ...
  return (
    <footer className="foot">
      ...
      <div className="footer-legal">
        <a href="/ru/legal/terms" data-lang-en="Terms of Service" data-lang-ru="Условия обслуживания">Условия обслуживания</a> · 
        <a href="/ru/legal/privacy" data-lang-en="Privacy Policy" data-lang-ru="Политика конфиденциальности">Политика конфиденциальности</a> · 
        <a href="/ru/legal/cookies" data-lang-en="Cookie Policy" data-lang-ru="Политика файлов cookie">Политика файлов cookie</a> · 
      ...
      <p className="footer-rights" data-lang-en="All rights reserved. Unauthorized reproduction or distribution of content is prohibited." data-lang-ru="Все права защищены. Несанкционированное воспроизведение или распространение контента запрещено.">
        Все права защищены. Несанкционированное воспроизведение или распространение контента запрещено.
      </p>
