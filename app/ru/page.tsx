      ...
      <main>
        ...
        <section className="content-section">
          ...
          <div className="content-block">
            <h2 data-lang-en="AI People — the world's first AI models marketplace and virtual influencers platform." data-lang-ru="AI People — первый в мире маркетплейс AI-моделей и виртуальных инфлюенсеров.">AI People — первый в мире маркетплейс AI-моделей и виртуальных инфлюенсеров.</h2>
