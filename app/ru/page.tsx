    ...
    <div className="container ru-optimized home-page">
      ...
      <main>
        ...
        <section className="hero">
          ...
          <h2 className="hero-subtitle" data-lang-en="Первый в мире маркетплейс AI-моделей и платформа виртуальных инфлюенсеров." data-lang-ru="Первый в мире маркетплейс AI-моделей и платформа виртуальных инфлюенсеров.">Первый в мире маркетплейс AI-моделей и платформа виртуальных инфлюенсеров.</h2>
