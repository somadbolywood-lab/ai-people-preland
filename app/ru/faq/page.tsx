        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "Что такое маркетплейс AI-People?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "AI-People — первый в мире курируемый маркетплейс гиперреалистичных AI-моделей и виртуальных инфлюенсеров. Мы соединяем креаторов, создающих AI-контент, с бизнесом, ищущим экономически эффективные высококачественные визуалы для маркетинговых кампаний."
                }
              },
              {
                "@type": "Question", 
                "name": "Сколько могут зарабатывать креаторы на AI-People?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Успешные креаторы на нашей платформе уже зарабатывают от $5,000 до $25,000 в месяц, продавая гиперреалистичные AI-модели и контент виртуальных инфлюенсеров. Доходы зависят от качества вашего контента и маркетинговых усилий."
                }
              },
              {
                "@type": "Question",
                "name": "Какие типы AI-моделей можно покупать и продавать?",
                "acceptedAnswer": {
                  "@type": "Answer", 
                  "text": "Вы можете покупать и продавать гиперреалистичные AI-модели, виртуальных инфлюенсеров, цифровых людей, AI-генерированные произведения искусства и кастомные пакеты контента. Весь контент поставляется с полными коммерческими лицензионными правами."
                }
              },
              {
                "@type": "Question",
                "name": "Когда запускается AI-People?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "AI-People официально запускается 1 ноября 2025 года. Ранние подписчики получают эксклюзивный доступ, специальные функции и привилегии членов-основателей."
                }
              },
              {
                "@type": "Question",
                "name": "Как начать работать как креатор?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Просто присоединитесь к нашему списку ожидания, создайте профиль креатора, загрузите ваши гиперреалистичные AI-модели, установите цены и начните зарабатывать с каждой продажи. Мы предоставляем маркетинговую поддержку и обслуживание клиентов."
                }
              }
            ]
          })
