...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>AI-People FAQ: Часто задаваемые вопросы о маркетплейсе AI-моделей | 2025</title>
        <meta name="description" content="Получите ответы на часто задаваемые вопросы о маркетплейсе AI-People, AI-моделях, виртуальных инфлюенсерах, ценах, лицензировании и как начать зарабатывать с AI-контентом." />
