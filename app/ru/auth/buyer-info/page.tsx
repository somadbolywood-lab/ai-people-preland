      ...
      <main>
        ...
        <section className="content-section" style={{maxWidth: '1200px', margin: '0 auto', padding: '2rem 1rem'}}>
          <div className="content-block">
            ...
            <h3 style={{marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem'}} data-lang-en="💡 How this will help you earn and save time?" data-lang-ru="💡 Как это поможет вам зарабатывать и экономить время?">💡 Как это поможет вам зарабатывать и экономить время?</h3>
            <ul style={{marginLeft: '1.5rem', marginBottom: '2rem', lineHeight: '1.8'}}>
              <li data-lang-en="Create subscription services (OnlyFans, Patreon, Boosty) without real models. AI content already sells and gathers subscribers." data-lang-ru="Создавайте подписочные сервисы (ОнлиФанс, Патреон, Бусти) без участия реальных моделей. ИИ-контент уже продаётся и собирает подписчиков.">Создавайте подписочные сервисы (ОнлиФанс, Патреон, Бусти) без участия реальных моделей. ИИ-контент уже продаётся и собирает подписчиков.</li>
              <li data-lang-en="Promote your business — use unique images and videos for advertising products, building a brand or increasing sales." data-lang-ru="Продвигайте бизнес — используйте уникальные изображения и видео для рекламы продуктов, построения бренда или увеличения продаж.">Продвигайте бизнес — используйте уникальные изображения и видео для рекламы продуктов, построения бренда или увеличения продаж.</li>
              <li data-lang-en="Become a reseller — resell ready-made photo and video packages on digital content platforms." data-lang-ru="Станьте реселлером — перепродавайте готовые пакеты фото и видео на платформах с цифровым контентом.">Станьте реселлером — перепродавайте готовые пакеты фото и видео на платформах с цифровым контентом.</li>
              <li data-lang-en="Save time and money — no need to hire models, photographers, videographers. Everything is ready." data-lang-ru="Экономьте время и деньги — не нужно нанимать моделей, фотографов, видеографов. Всё уже готово.">Экономьте время и деньги — не нужно нанимать моделей, фотографов, видеографов. Всё уже готово.</li>
              <li data-lang-en="Get custom content — which means you'll always have materials that no one else has." data-lang-ru="Получайте контент под заказ — а значит, всегда будете иметь материалы, которых нет ни у кого.">Получайте контент под заказ — а значит, всегда будете иметь материалы, которых нет ни у кого.</li>
            </ul>
            
            <p className="role-cta-text" style={{fontSize: '1.1rem', marginBottom: '2rem'}} data-lang-en="⚡ This is not just a collection — it's your tool for monetizing ideas and reaching a new level in the digital space. Subscribe to the waiting list now and get access to premium content and first releases before everyone else!" data-lang-ru="⚡ Это не просто коллекция — это ваш инструмент для монетизации идей и выхода на новый уровень в цифровом пространстве. Подпишитесь на лист ожидания сейчас и получите доступ к премиум-контенту и первым релизам раньше всех!">⚡ Это не просто коллекция — это ваш инструмент для монетизации идей и выхода на новый уровень в цифровом пространстве. Подпишитесь на лист ожидания сейчас и получите доступ к премиум-контенту и первым релизам раньше всех!</p>
            ...
            <ul style={{marginLeft: '1.5rem', marginBottom: '2rem', lineHeight: '1.8'}}>
              <li data-lang-en="Use all purchased content exclusively for legal and legitimate purposes" data-lang-ru="Используйте весь приобретенный контент исключительно в законных и легитимных целях">Используйте весь приобретенный контент исключительно в законных и легитимных целях</li>
              <li data-lang-en="Respect creator rights, copyrights, and intellectual property" data-lang-ru="Уважайте права креаторов, авторские права и интеллектуальную собственность">Уважайте права креаторов, авторские права и интеллектуальную собственность</li>
              <li data-lang-en="Follow platform terms of service and community guidelines" data-lang-ru="Соблюдайте условия использования платформы и правила сообщества">Соблюдайте условия использования платформы и правила сообщества</li>
              <li data-lang-en="Maintain respectful and professional communication through the platform" data-lang-ru="Поддерживайте уважительное и профессиональное общение через платформу">Поддерживайте уважительное и профессиональное общение через платформу</li>
              <li data-lang-en="Provide clear requirements and feedback for custom orders" data-lang-ru="Предоставляйте четкие требования и обратную связь для индивидуальных заказов">Предоставляйте четкие требования и обратную связь для индивидуальных заказов</li>
              <li data-lang-en="Pay for services promptly and according to agreed terms" data-lang-ru="Оплачивайте услуги своевременно и согласно согласованным условиям">Оплачивайте услуги своевременно и согласно согласованным условиям</li>
              <li data-lang-en="Report any inappropriate content or behavior to platform moderators" data-lang-ru="Сообщайте о любом неподходящем контенте или поведении модераторам платформы">Сообщайте о любом неподходящем контенте или поведении модераторам платформы</li>
            </ul>
