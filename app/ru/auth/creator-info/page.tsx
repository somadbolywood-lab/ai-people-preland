      ...
      <main>
        ...
        <section className="content-section" style={{maxWidth: '1200px', margin: '0 auto', padding: '2rem 1rem'}}>
          <div className="content-block">
            ...
            <h3 style={{marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem'}} data-lang-en="What You Get" data-lang-ru="Что вы получаете">Что вы получаете</h3>
            ...
            <h3 style={{marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem'}} data-lang-en="Why It's Profitable for You" data-lang-ru="Почему это прибыльно для вас">Почему это прибыльно для вас</h3>
            ...
            <h3 style={{marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem'}} data-lang-en="Creator Commitments" data-lang-ru="Обязательства креатора">Обязательства креатора</h3>
            <ul style={{marginLeft: '1.5rem', marginBottom: '2rem', lineHeight: '1.8'}}>
            ...
            <h3 style={{marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem'}} data-lang-en="Your Future Starts Here" data-lang-ru="Ваше будущее начинается здесь">Ваше будущее начинается здесь</h3>
