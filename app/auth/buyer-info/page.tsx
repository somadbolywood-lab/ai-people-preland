        ...
        <section className="content-section" style={{maxWidth: '1200px', margin: '0 auto', padding: '2rem 1rem'}}>
          <div className="content-block">
            ...
            <ul style={{marginLeft: '1.5rem', marginBottom: '2rem', lineHeight: '1.8'}}>
              <li data-lang-en="Build and grow your subscription business (OnlyFans, Patreon, Boosty) — with 100% AI-generated content that sells." data-lang-ru="Стройте и развивайте подписочный бизнес (OnlyFans, Patreon, Boosty) — с 100% AI‑контентом, который продаётся.">Build and grow your subscription business (OnlyFans, Patreon, Boosty) — with 100% AI-generated content that sells.</li>
