...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Первый маркетплейс AI-моделей в мире. Покупайте и продавайте гиперреалистичных виртуальных инфлюенсеров. Креаторы зарабатывают $5К-$25К/месяц. Запуск 01.11.2025.',
    siteName: 'AI-People',
    images: [
      {
  ...
  twitter: {
    ...
    description: 'Первый маркетплейс AI-моделей. Креаторы зарабатывают $5К-$25К/месяц. Запуск 01.11.2025.',
